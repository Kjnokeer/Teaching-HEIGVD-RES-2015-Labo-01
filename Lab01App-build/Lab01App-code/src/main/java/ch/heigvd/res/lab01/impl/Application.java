...
public class Application implements IApplication {
   ...
   void storeQuote(Quote quote, String filename) throws IOException {
      ...
      StringBuffer path = new StringBuffer(WORKSPACE_DIRECTORY + "/");
      File file;
      ...
      file = new File(path.toString() + filename + ".utf8");
      file.createNewFile();

      fos = new FileOutputStream(file);
      fos.write(quote.getQuote().getBytes("UTF-8"));
      fos.close();
   }
   ...
   public String getAuthorEmail() {
      return "mathias.dolt@heig-vd.ch";
   }
